...
def get_ulbps_ulbonly(simMat,yl,num=8):
    ...
    Lu = L[:num,:num]               # the diagnal value of Lu is different from Ls.
    Lmix = L[:num,num:]
    ...
    # print('the shape of r1 and u are', r1.shape, u.shape)
    r = torch.matmul(r1,u)
...
def ulb_rank(input_feat_unl, input_feat_l, yl,lambda_val = -1,subsamp = False):
    ...
    # samples_l = random.sample(selected_indices, 6)
    ...
    labels_ulpbs,r= get_ulbps_ulbonly(feat_cosim,yl,num=8)
...
def ulb_rank_cps(input_feat_unl_0, input_feat_unl_1, input_feat_l_0, input_feat_l_1,yl,lambda_val = -1, subsamp = False, batch_size_two = 8, num=8):
    ...
    #print(p.shape)
    # print('the shape of p_unl_0 and 1 are', p_unl_0.shape, p_unl_1.shape)
    ...
    indices = minimize_matrix_sum(feat_cosim_unl_diff,5)
    # print(indices)
    # yl=yl[indices]
    # print(indices)
    #feat_cosim_unl_diff = torch.abs(feat_cosim_unl_0-feat_cosim_unl_1)
    ...
    # exit()
    feat_cosim_unl = feat_cosim[:5,:5]
    labels_ulpbs,r = get_ulbps_ulbonly(feat_cosim,yl,num=5)
    labels_ulbpsdornk = labels_ulpbs    
    # print(labels_ulbpsdornk.shape)
    ...
    return loss_ulb, ps_ulb_ranked, indices,r
